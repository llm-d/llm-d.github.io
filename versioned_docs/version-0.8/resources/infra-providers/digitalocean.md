...
For deployment instructions, see the [well-lit path guides](/docs/well-lit-paths).
...
Follow the [well-lit path guides](/docs/well-lit-paths) to deploy llm-d workloads. Each guide includes DigitalOcean-specific steps where applicable.
