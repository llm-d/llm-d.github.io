...
The [`InferenceModelRewrite`](/docs/api-reference/inferencemodelrewrite) resource allows platform administrators and model owners to control how inference requests are routed to specific models within an InferencePool.
...
Follow the [getting started guide](/docs) to set up the llm-d stack.
