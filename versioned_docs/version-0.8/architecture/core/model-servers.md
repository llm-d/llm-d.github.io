...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/basic-architecture.svg" alt="Architecture" />
  </picture>
</p>
...
[optimized-baseline TensorRT-LLM recipe](https://github.com/llm-d/llm-d/blob/release-0.8/guides/optimized-baseline/README.md) for a
