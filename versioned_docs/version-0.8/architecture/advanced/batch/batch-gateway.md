...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/batch-gateway.svg" alt="Batch Gateway Architecture" />
  </picture>
</p>
...
- [Batch Gateway Deployment Guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/batch-gateway) — deployment instructions, configuration options, and usage.
