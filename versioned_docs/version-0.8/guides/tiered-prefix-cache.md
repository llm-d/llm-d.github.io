---
slug: /well-lit-paths/tiered-prefix-cache
---
...
See the [Tiered Prefix Cache guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/tiered-prefix-cache) for manifests and step-by-step deployment.
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/cpu-offloading.svg" alt="CPU KV Cache Offloading" />
  </picture>
</p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" />
    <img src="/img/docs/fs-offloading.svg" alt="Tiered Offloading to Filesystem" />
  </picture>
</p>

## Further Reading

- [Tiered Prefix Cache guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/tiered-prefix-cache) — manifests and step-by-step deployment.
