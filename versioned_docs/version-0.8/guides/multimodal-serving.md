...
:::note
For the high-level scheduling architecture flow and EPP load-balancing diagrams, see the [Optimized Baseline guide](/docs/well-lit-paths/optimized-baseline#architecture).
:::
...
* See [Optimized Baseline](/docs/well-lit-paths/optimized-baseline) for details on text-based scheduling and general load-balancing.
