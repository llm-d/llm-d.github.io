---
slug: /well-lit-paths/no-kubernetes-deployment
---
...
See the [no-Kubernetes deployment guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/no-kubernetes-deployment) for manifests and step-by-step deployment.
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/no-kubernetes-deployment.svg" alt="No-Kubernetes Deployment" />
  </picture>
</p>
