---
slug: /well-lit-paths/agentic-serving
---
...
The [agentic-serving guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/agentic-serving) is the operational counterpart. It
composes llm-d's existing well-lit paths into a deployment stack — the
[optimized baseline](/docs/well-lit-paths/optimized-baseline) for prefix- and load-aware routing,
[tiered KV-cache offloading](/docs/well-lit-paths/tiered-prefix-cache) to keep idle sessions resident,
[precise prefix-cache routing](/docs/well-lit-paths/precise-prefix-cache-routing) for exact KV-state visibility, and [P/D disaggregation](/docs/well-lit-paths/pd-disaggregation) for interactivity under load — into
