---
slug: /well-lit-paths/batch-gateway
---
...
- A working llm-d Router, inference pool, and at least one model server. If you don't have this, start with [getting-started/quickstart.md](/docs/getting-started/quickstart).
...
- [Batch Gateway Deployment Guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/batch-gateway) — full deployment instructions, configuration options, and troubleshooting.
...
- [Asynchronous Processing](https://github.com/llm-d/llm-d/tree/release-0.8/guides/asynchronous-processing) — complementary queue-based async inference for individual requests.
