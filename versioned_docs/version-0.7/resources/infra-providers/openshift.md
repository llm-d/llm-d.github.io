...
![machinesets](/img/docs/0.7/machinesets.png)
...
![operators](/img/docs/0.7/installed_operators.png)
...
![Grafana dashboard empty of data](/img/docs/0.7/grafana_empty.png)
...
![AnythingLLM Configuration](/img/docs/0.7/anythingllm.png)


You are now ready to test llm-d.  Start some conversations with AnythingLLM and watch the Grafana dashboard light up.

![Grafana dashboard full of data](/img/docs/0.7/grafana_full.png)
