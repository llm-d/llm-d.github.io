...
- [client setup prerequisites](https://github.com/llm-d/llm-d/tree/release-0.7/helpers/client-setup)
...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------- | -------------- | ---------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A100      | [Standard_NC24ads_A100_v4](https://github.com/llm-d/llm-d/tree/release-0.7/guides/precise-prefix-cache-aware)                                                                                                                                                                                                            |
| A100      | [Standard_ND96asr_v4](https://github.com/llm-d/llm-d/tree/release-0.7/guides/precise-prefix-cache-aware)                                                                                                                                                                                                            |
| A100      | [Standard_ND96amsr_A100_v4](https://github.com/llm-d/llm-d/tree/release-0.7/guides/precise-prefix-cache-aware)                                                                                                                                                                                                            |
| H100      | [Standard_ND96isr_H100_v5](https://github.com/llm-d/llm-d/tree/release-0.7/guides/pd-disaggregation) (2 nodes required with vLLM flag `--max-model-len=4500`)                                                                              |
| H200      | [Standard_ND96isr_H200_v5](https://github.com/llm-d/llm-d/tree/release-0.7/guides/wide-ep-lws) (4 nodes required)|

## Cluster Configuration

GPUDirect RDMA is essential for achieving optimal performance with advanced deployment patterns such as [P/D Disaggregation](https://github.com/llm-d/llm-d/tree/release-0.7/guides/wide-ep-lws). To enable GPUDirect RDMA, you must create and configure a GPU node pool with the appropriate VM size and install the required drivers.
