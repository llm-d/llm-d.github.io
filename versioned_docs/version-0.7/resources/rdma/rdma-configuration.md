...
![Networking Stack](/img/docs/0.7/networking-stack.svg)
...
- [P/D Disaggregation Well-Lit Path](/docs/0.7/guides/pd-disaggregation) — deployment patterns using NIXL
- [Wide Expert-Parallelism Well-Lit Path](/docs/0.7/guides/wide-expert-parallelism) — multi-node deployment with DeepEP networking
- [Model Servers](/docs/0.7/architecture/core/model-servers) — vLLM/SGLang configuration including KV transfer flags
