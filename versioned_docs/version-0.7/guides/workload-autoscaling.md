...
See the [workload autoscaling guide](https://github.com/llm-d/llm-d/tree/release-0.7/guides/workload-autoscaling) for manifests and step-by-step deployment instructions for both paths.
