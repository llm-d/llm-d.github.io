...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/0.7/prefix-aware-routing.svg" alt="Prefix-Aware Routing" />
  </picture>
</p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" />
    <img src="/img/docs/0.7/load-aware-routing.svg" alt="Load-Aware Routing" />
  </picture>
</p>

## Further Reading

See [EPP Architecture](/docs/0.7/architecture/core/router/epp) for more details.
