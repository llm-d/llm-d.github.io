...
| Google | [TPU](/docs/0.7/resources/infra-providers/gke#llm-d-on-google-kubernetes-engine-gke) | Edwin Hernandez (@Edwinhr716), Cong Liu (@liu-cong, congliu.thu@gmail.com) |
...
Google Cloud TPUs (v6e, v7) are supported when running on GKE. See the [GKE infrastructure provider docs](/docs/0.7/resources/infra-providers/gke) for cluster setup.
