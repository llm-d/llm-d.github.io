...
sidebar_label: Accelerator Simulation
sidebar_position: 14
...
**_NOTE:_** This uses Istio as the default provider, see [Gateway Options](https://github.com/llm-d/llm-d/blob/main/guides/simulated-accelerators/README.md#gateway-options) for installing with a specific provider.
...
:::info Content Source
This content is automatically synced from [guides/simulated-accelerators/README.md](https://github.com/llm-d/llm-d/blob/main/guides/simulated-accelerators/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/simulated-accelerators/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
