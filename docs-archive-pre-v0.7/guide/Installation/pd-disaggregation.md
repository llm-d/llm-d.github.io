...
**_NOTE:_** This uses Istio as the default provider, see [Gateway Options](https://github.com/llm-d/llm-d/blob/main/guides/pd-disaggregation/README.md#gateway-options) for installing with a specific provider.
...
In this example, we deployed the user guide on GKE using the modified [Gateway options](https://github.com/llm-d/llm-d/blob/main/guides/pd-disaggregation/README.md#gateway-options) described above:
...
The `GATEWAY_IP` environment variable will be used in the [benchmark template](https://github.com/llm-d/llm-d/blob/main/guides/pd-disaggregation/benchmark-templates/guide.yaml).
...
<img src="https://github.com/llm-d/llm-d/raw/main/guides/pd-disaggregation/latency_vs_concurrency.png" width="900" alt="Latency vs Concurrency" />
<img src="https://github.com/llm-d/llm-d/raw/main/guides/pd-disaggregation/throughput_vs_concurrency.png" width="900" alt="Throughput vs Concurrency" />
<img src="https://github.com/llm-d/llm-d/raw/main/guides/pd-disaggregation/throughput_vs_latency.png" width="900" alt="Throughput vs Latency" />
...
:::info Content Source
This content is automatically synced from [guides/pd-disaggregation/README.md](https://github.com/llm-d/llm-d/blob/main/guides/pd-disaggregation/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/pd-disaggregation/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
