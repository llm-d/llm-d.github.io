...
sidebar_label: Prefix Cache Offloading - CPU
sidebar_position: 5
...
* All prerequisites from the [upper level](/docs/guide/Installation/tiered-prefix-cache).
...
<Tabs>
<TabItem value="offloading-connector" label="Offloading Connector" default>
...
<TabItem value="lmcache-connector" label="LMCache Connector">
...
To enable tiered prefix caching, we customize the `InferencePool` configuration (see [`manifests/inferencepool/values.yaml`](https://github.com/llm-d/llm-d/blob/main/guides/tiered-prefix-cache/cpu/manifests/inferencepool/values.yaml)). We configure two prefix cache scorers: one for the GPU cache and another for the CPU cache.
...
:::info Content Source
This content is automatically synced from [guides/tiered-prefix-cache/cpu/README.md](https://github.com/llm-d/llm-d/blob/main/guides/tiered-prefix-cache/cpu/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/tiered-prefix-cache/cpu/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
