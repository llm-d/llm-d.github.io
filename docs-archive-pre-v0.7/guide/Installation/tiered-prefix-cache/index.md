...
sidebar_label: Prefix Cache Offloading
sidebar_position: 4
...
The prefix aware request scheduling optimizations in the [optimized baseline](/docs/guide/Installation/optimized-baseline) also applies here.
...
See the [CPU offloading guide](/docs/guide/Installation/tiered-prefix-cache/cpu) to learn how to enable CPU RAM offloading with llm-d.
...
To enable local disk offloading, refer to the [**Storage Offloading Guide**](https://github.com/llm-d/llm-d/blob/main/guides/tiered-prefix-cache/storage/README.md). The guide uses a generic storage connector that can connect to both local and remote/shared storage backends.
...
:::info Content Source
This content is automatically synced from [guides/tiered-prefix-cache/README.md](https://github.com/llm-d/llm-d/blob/main/guides/tiered-prefix-cache/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/tiered-prefix-cache/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
