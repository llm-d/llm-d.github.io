...
sidebar_label: Intelligent Inference Scheduling
sidebar_position: 3
...
:::note
GKE provides [automatic application monitoring](https://docs.cloud.google.com/kubernetes-engine/docs/how-to/configure-automatic-application-monitoring) out of the box. The llm-d [Monitoring stack](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/README.md) is not required for GKE, but it is available if you prefer to use it.
:::

- Install the [Monitoring stack](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/README.md).
...
For more details, refer to the [benchmark instructions doc](https://github.com/llm-d/llm-d/blob/main/helpers/benchmark.md).
...
- [Create HuggingFace token](https://github.com/llm-d/llm-d/blob/main/helpers/hf-token.md)
...
<img src="https://github.com/llm-d/llm-d/raw/main/guides/optimized-baseline/benchmark-results/latency_vs_qps.png" width="900" alt="Throughput vs QPS" />
<img src="https://github.com/llm-d/llm-d/raw/main/guides/optimized-baseline/benchmark-results/throughput_vs_qps.png" width="450" alt="Throughput vs Latency" />
...
:::info Content Source
This content is automatically synced from [guides/optimized-baseline/README.md](https://github.com/llm-d/llm-d/blob/main/guides/optimized-baseline/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/optimized-baseline/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
