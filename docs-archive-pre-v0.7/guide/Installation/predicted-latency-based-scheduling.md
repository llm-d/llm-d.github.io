...
sidebar_label: Predicted Latency Based Load Balancing
sidebar_position: 8
...
:::info Content Source
This content is automatically synced from [guides/predicted-latency-based-scheduling/README.md](https://github.com/llm-d/llm-d/blob/main/guides/predicted-latency-based-scheduling/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/predicted-latency-based-scheduling/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
