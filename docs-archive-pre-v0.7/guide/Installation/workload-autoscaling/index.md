...
sidebar_label: Workload Autoscaling
sidebar_position: 11
...
:::info Content Source
This content is automatically synced from [guides/workload-autoscaling/README.md](https://github.com/llm-d/llm-d/blob/main/guides/workload-autoscaling/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/workload-autoscaling/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
