...
sidebar_label: Autoscaling with HPA and EPP Metrics
sidebar_position: 13
...
:::info Content Source
This content is automatically synced from [guides/workload-autoscaling/README.hpa-epp.md](https://github.com/llm-d/llm-d/blob/main/guides/workload-autoscaling/README.hpa-epp.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/workload-autoscaling/README.hpa-epp.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
