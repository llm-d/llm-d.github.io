...
sidebar_label: Precise Prefix Cache Aware Routing
sidebar_position: 7
...
**_NOTE:_** This uses Istio as the default provider, see [Gateway Options](https://github.com/llm-d/llm-d/blob/main/guides/precise-prefix-cache-aware/README.md#gateway-options) for installing with a specific provider.
...
We have docs on getting started sending inference requests [available here](https://github.com/llm-d/llm-d/blob/main/guides/02_verifying_a_guide.md) that are general to all examples. However, this example has unique instructions to interact with it which will be provided here:
...
To run benchmarks against the installed llm-d stack, you need [run_only.sh](https://github.com/llm-d/llm-d-benchmark/blob/main/existing_stack/run_only.sh), a template file from [benchmark-templates](https://github.com/llm-d/llm-d/blob/main/guides/precise-prefix-cache-aware/benchmark-templates/), and a Persistent Volume Claim (PVC) to store the results (optional). Follow the instructions in the [benchmark doc](https://github.com/llm-d/llm-d/blob/main/helpers/benchmark.md).

### Example

This example uses [run_only.sh](https://github.com/llm-d/llm-d-benchmark/blob/main/existing_stack/run_only.sh) with the template [guide.yaml](https://github.com/llm-d/llm-d/blob/main/guides/precise-prefix-cache-aware/benchmark-templates/guide.yaml).
...
Several results files will be created (see [Benchmark doc](https://github.com/llm-d/llm-d/blob/main/helpers/benchmark.md)), including a yaml file in a "standard" benchmark report format (see [Benchmark Report](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/benchmark_report.md)).

The `bash` commands below downloads the benchmark runner script (`run_only.sh`), then presents an interactive menu of Precise-Prefix benchmark templates from the llm-d repository's [`./benchmark-templates/`](https://github.com/llm-d/llm-d/blob/main/guides/precise-prefix-cache-aware/benchmark-templates/) directory. Once the user selects a template, it downloads that specific YAML configuration file for running benchmarks.
...
<img src="https://github.com/llm-d/llm-d/raw/main/guides/precise-prefix-cache-aware/benchmark-results/latency_vs_qps.png" width="900" alt="Throughput vs QPS" />
<img src="https://github.com/llm-d/llm-d/raw/main/guides/precise-prefix-cache-aware/benchmark-results/throughput_vs_qps.png" width="450" alt="Throughput vs Latency" />
...
:::info Content Source
This content is automatically synced from [guides/precise-prefix-cache-aware/README.md](https://github.com/llm-d/llm-d/blob/main/guides/precise-prefix-cache-aware/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/guides/precise-prefix-cache-aware/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
