...
- [client setup prerequisites](https://github.com/llm-d/llm-d/blob/main/helpers/client-setup/README.md)
...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------- | -------------- | ---------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A100      | [Standard_NC24ads_A100_v4](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/nca100v4-series?tabs=sizebasic)    | 1         | 80 GB          | 80 GB            | ❌                           | [optimized baseline](/docs/guide/Installation/optimized-baseline)<br />[Precise Prefix Cache Aware Routing](/docs/guide/Installation/precise-prefix-cache-aware)                                                                                                                                                                                                            |
| A100      | [Standard_ND96asr_v4](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/ndasra100v4-series?tabs=sizebasic)      | 8         | 40 GB          | 320 GB           | ✅                           | [optimized baseline](/docs/guide/Installation/optimized-baseline)<br />[Precise Prefix Cache Aware Routing](/docs/guide/Installation/precise-prefix-cache-aware)                                                                                                                                                                                                            |
| A100      | [Standard_ND96amsr_A100_v4](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/ndma100v4-series?tabs=sizebasic)  | 8         | 80 GB          | 640 GB           | ✅                           | [optimized baseline](/docs/guide/Installation/optimized-baseline)<br />[Precise Prefix Cache Aware Routing](/docs/guide/Installation/precise-prefix-cache-aware)                                                                                                                                                                                                            |
| H100      | [Standard_ND96isr_H100_v5](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/ndh100v5-series?tabs=sizebasic)    | 8         | 80 GB          | 640 GB           | ✅                           | [optimized baseline](/docs/guide/Installation/optimized-baseline)<br />[Precise Prefix Cache Aware Routing](/docs/guide/Installation/precise-prefix-cache-aware)<br />[P/D Disaggregation](/docs/guide/Installation/pd-disaggregation) (2 nodes required with vLLM flag `--max-model-len=4500`)                                                                              |
| H200      | [Standard_ND96isr_H200_v5](https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/nd-h200-v5-series?tabs=sizebasic)  | 8         | 141 GB         | 1128 GB          | ✅                           | [optimized baseline](/docs/guide/Installation/optimized-baseline)<br />[Precise Prefix Cache Aware Routing](/docs/guide/Installation/precise-prefix-cache-aware)<br />[P/D Disaggregation](/docs/guide/Installation/pd-disaggregation) (2 nodes required)<br />[Wide Expert Parallelism (EP/DP) with LeaderWorkerSet](/docs/guide/Installation/wide-ep-lws) (4 nodes required)|

## Cluster Configuration

GPUDirect RDMA is essential for achieving optimal performance with advanced deployment patterns such as [P/D Disaggregation](/docs/guide/Installation/pd-disaggregation) and [Wide Expert Parallelism](/docs/guide/Installation/wide-ep-lws). To enable GPUDirect RDMA, you must create and configure a GPU node pool with the appropriate VM size and install the required drivers.
...
:::info Content Source
This content is automatically synced from [docs/infra-providers/aks/README.md](https://github.com/llm-d/llm-d/blob/main/docs/infra-providers/aks/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/docs/infra-providers/aks/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
