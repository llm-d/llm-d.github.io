...
| Path | GPU | TPU |
| --- | --- | --- |
| [optimized baseline](/docs/guide/Installation/optimized-baseline) | Large models (13B+) with Hopper or newer (A3 or newer)<br />Small or highly quantized models (1-7B) with Ampere, L4, or newer (A2, G2, or newer) | v5e, v6e, 7x|
| [Prefill / Decode Disaggregation](/docs/guide/Installation/pd-disaggregation) | RDMA-enabled machine types (A3U, A4, or newer) | v6e, 7x |
| [Wide Expert Parallelism](/docs/guide/Installation/wide-ep-lws) | RDMA-enabled machine types (A3U, A4, or newer) | coming soon |
| [Tiered Prefix Cache](/docs/guide/Installation/tiered-prefix-cache) | Tiered Prefix Cache can be combined with other well-lit paths above.<br />If running Prefill/Decode Disaggregation, or Wide Expert Parallelism, follow their guidance respectively.<br />Otherwise, follow the guidance on optimized baseline. | coming soon |
...
:::info Content Source
This content is automatically synced from [docs/infra-providers/gke/README.md](https://github.com/llm-d/llm-d/blob/main/docs/infra-providers/gke/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/docs/infra-providers/gke/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
