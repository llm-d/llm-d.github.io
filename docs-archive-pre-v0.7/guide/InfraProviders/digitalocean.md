...
sidebar_label: DigitalOcean Kubernetes Service (DOKS)
sidebar_position: 2
...
For detailed configuration options and advanced setups, see the main [llm-d guides](https://github.com/llm-d/llm-d/blob/main/guides).

:::info Content Source
This content is automatically synced from [docs/infra-providers/digitalocean/README.md](https://github.com/llm-d/llm-d/blob/main/docs/infra-providers/digitalocean/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/docs/infra-providers/digitalocean/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
