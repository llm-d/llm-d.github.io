...
- In other Kubernetes environments, Prometheus custom resources must be available in the cluster. To install a simple Prometheus and Grafana stack,
  refer to [prometheus-grafana-stack.md](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/prometheus-grafana-stack.md).

### Helmfile Integration

All [llm-d guides](/docs/guide) have monitoring enabled by default, supporting multiple monitoring stacks depending on the environment. We provide out of box monitoring configurations for scraping the [Endpoint Picker (EPP)](https://github.com/kubernetes-sigs/gateway-api-inference-extension/tree/main/docs/proposals/004-endpoint-picker-protocol) metrics, and vLLM metrics.
...
llm-d supports OpenTelemetry distributed tracing across vLLM, the routing proxy, and the EPP/inference scheduler. See [Distributed Tracing](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/tracing/README.md) for setup instructions, or use the [install-otel-collector-jaeger.sh](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/scripts/install-otel-collector-jaeger.sh) script to deploy an OTel Collector and Jaeger backend with one command.
...
- [llm-d vLLM Overview dashboard](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/grafana/dashboards/llm-d-vllm-overview.json)
  - General vLLM metrics overview for monitoring llm-d inference servers
- [llm-d Failure & Saturation Indicators dashboard](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/grafana/dashboards/llm-d-failure-saturation-dashboard.json)
  - Key failure and saturation indicators for identifying system issues and capacity constraints
- [llm-d Diagnostic Drill-Down dashboard](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/grafana/dashboards/llm-d-diagnostic-drilldown-dashboard.json)
  - Detailed diagnostic metrics for investigating performance issues
- [llm-d Performance Dashboard](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/grafana/dashboards/llm-performance-kv-cache.json)
  - Performance metrics including KV cache utilization
- [P/D Coordinator Metrics dashboard](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/grafana/dashboards/pd-coordinator-metrics.json)
...
- [Example PromQL Queries](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/example-promQL-queries.md) - Ready-to-use queries for monitoring vLLM, EPP, and prefix caching metrics

## Load Testing and Error Generation

To populate metrics (especially error metrics) for testing and monitoring validation:

- [Traffic Generation Script](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/scripts/generate-traffic-basic.sh) - Sends both valid and malformed requests to generate metrics
- [P/D Traffic Generator](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/scripts/generate-traffic-pd.sh) - Concurrent traffic optimized for P/D disaggregation tracing
...
:::info Content Source
This content is automatically synced from [docs/monitoring/README.md](https://github.com/llm-d/llm-d/blob/main/docs/monitoring/README.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/docs/monitoring/README.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
