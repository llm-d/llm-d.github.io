...
sidebar_position: 4
keywords: [llm-d, inference simulator, vLLM simulator, testing, development]
---
...
[![License](https://img.shields.io/github/license/llm-d/llm-d-inference-sim)](https://github.com/llm-d/llm-d-inference-sim/blob/main/LICENSE)
...
For detailed API definitions see the [APIs Guide](https://github.com/llm-d/llm-d-inference-sim/blob/main/docs/api.md).
...
For response generation algorithms details see [Response Generation Guide](https://github.com/llm-d/llm-d-inference-sim/blob/main/docs/response_generation.md).
...
For details on caching, and performance tuning, see the [Tokenization Guide](https://github.com/llm-d/llm-d-inference-sim/blob/main/docs/tokenization.md).
...
### Prefill/Decode (P/D)
The configuration for P/D disaggregation deployment can be found in [manifests/disaggregation](https://github.com/llm-d/llm-d-inference-sim/blob/main/manifests/disaggregation).
...
Image Repository: [ghcr.io/llm-d/llm-d-inference-sim](https://github.com/llm-d/llm-d-inference-sim/blob/main/ghcr.io/llm-d/llm-d-inference-sim)
...
To deploy the simulator in a cluster, update your deployment manifest to point to the official image. An example configuration can be found in [manifests/deployment.yaml](https://github.com/llm-d/llm-d-inference-sim/blob/main/manifests/deployment.yaml).
...
make dev-env-kind
```
Check [Makefile](https://github.com/llm-d/llm-d-inference-sim/blob/main/Makefile) for environment variables to tune the process.
For example:
```bash
...
:::info Content Source
This content is automatically synced from [README.md](https://github.com/llm-d/llm-d-inference-sim/blob/main/README.md) on the `main` branch of the llm-d/llm-d-inference-sim repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d-inference-sim/edit/main/README.md) or [create an issue](https://github.com/llm-d/llm-d-inference-sim/issues).
:::
