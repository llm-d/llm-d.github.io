...
sidebar_label: Benchmark Tools
sidebar_position: 7
keywords: [llm-d, benchmark, performance testing, LLM inference, automation]
---
...
- **Continue with Quick Start Guide:** [Quickstart on Kind](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/quickstart.md)
...
- `-l guidellm` selects the guidellm harness
  ([workload/harnesses/guidellm-llm-d-benchmark.sh](https://github.com/llm-d/llm-d-benchmark/blob/main/workload/harnesses/guidellm-llm-d-benchmark.sh)).
...
[`config/scenarios/guides/multi-model-wva.yaml`](https://github.com/llm-d/llm-d-benchmark/blob/main/config/scenarios/guides/multi-model-wva.yaml)
...
[Workload Variant Autoscaler](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/workload-variant-autoscaler.md#2c-via-the-multi-model-wva-scenario-multiple-pools-one-wva-controller)
...
:::tip
`run` can also be used in debug mode (`-d` / `--debug`) which starts the harness pod with `sleep infinity` so you can exec into it and run commands interactively. See [this example](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/tutorials/run/run_interactively_example.md).
:::

See [workload/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/workload/README.md) for the full experiment file format and all pre-built experiments, as well as advanced functionality.

## Next Steps

| Topic | Where to look |
|-------|---------------|
| Configuration system, defaults, scenarios, overrides | [config/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/config/README.md) |
| Multi-model scenarios and the `shared:` block | [config/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/config/README.md#method-1-scenario-file-recommended-for-deployment-specific-config), [developer-guide](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/developer-guide.md#multi-stack-scenarios-and-the-shared-block) |
| Workload-variant-autoscaler, including multi-pool setup | [docs/workload-variant-autoscaler.md](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/workload-variant-autoscaler.md) |
| Workloads, harnesses, profiles, experiments | [workload/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/workload/README.md) |
| Standup phase, deployment methods, step details | [llmdbenchmark/standup/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/standup/README.md) |
| Smoketests, per-scenario validation, adding validators | [llmdbenchmark/smoketests/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/smoketests/README.md) |
| Run phase, benchmark execution, result collection | [llmdbenchmark/run/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/run/README.md) |
| Teardown phase and deep clean | [llmdbenchmark/teardown/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/teardown/README.md) |
| Design of Experiments (DoE) orchestration | [llmdbenchmark/experiment/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/experiment/README.md) |
| Plan-phase rendering pipeline | [llmdbenchmark/parser/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/parser/README.md) |
| Execution framework and step contribution guide | [llmdbenchmark/executor/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/executor/README.md) |
...
Smoketests also run automatically after `standup` unless `--skip-smoketest` is passed. See [llmdbenchmark/smoketests/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/smoketests/README.md) for details on what each step validates.
...
The tool operates in three phases, each composed of numbered steps executed by a shared [`StepExecutor`](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/executor/README.md) framework.

### [Config Override Chain](https://github.com/llm-d/llm-d-benchmark/blob/main/config/README.md#config-override-chain)

Values flow through a merge pipeline during the plan phase:

![Config Override Chain](https://github.com/llm-d/llm-d-benchmark/raw/main/docs/images/config-override-chain.svg)
...
See [config/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/config/README.md) for the full configuration reference, including [how to override values](https://github.com/llm-d/llm-d-benchmark/blob/main/config/README.md#how-to-override-values).

### [Deployment Methods](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/standup/README.md#deployment-methods)
...
### [Standup Steps](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/standup/README.md)
...
### [Run Steps](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/run/README.md)
...
### [Teardown Steps](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/teardown/README.md)
...
- [executor/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/executor/README.md) -- Execution framework and step contribution guide
- [smoketests/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/smoketests/README.md) -- Post-deployment validation and per-scenario config checking
- [standup/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/standup/README.md) -- Standup phase details
- [run/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/run/README.md) -- Run phase, benchmark execution, result collection
- [teardown/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/teardown/README.md) -- Teardown phase details
- [experiment/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/experiment/README.md) -- DoE experiment orchestration
- [parser/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/parser/README.md) -- Plan-phase rendering pipeline
- [logging/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/logging/README.md) -- Logger, stream separation, file logging
- [utilities/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/utilities/README.md) -- Shared utilities, workspace architecture
...
### [Harnesses](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/run.md#harnesses)
...
### (Workload) [Profiles](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/run.md#profiles)

Benchmark load specifications including LLM use case, traffic pattern, input/output distribution, and dataset. Found under [`workload/profiles`](https://github.com/llm-d/llm-d-benchmark/blob/main/workload/profiles).
...
- KubeCon/CloudNativeCon 2025 North America Talk "A Cross-Industry Benchmarking Tutorial for Distributed LLM Inference on Kubernetes", with the [accompanying tutorial](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/tutorials/kubecon/README.md)
...
- [Analysis Pipeline](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/analysis.md)
- [Metrics Collection](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/metrics_collection.md)
- [Benchmark Report](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/benchmark_report.md)
- [Design of Experiments (DoE)](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/doe.md)
- [Lifecycle](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/lifecycle.md)
- [Run](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/run.md)
- [Standup](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/standup.md)
- [Reproducibility](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/reproducibility.md)
- [Observability](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/observability.md)
...
- [WVA (Workload Variant Autoscaler)](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/workload-variant-autoscaler.md)
- [Upstream Versions](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/upstream-versions.md)
- [FAQ](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/faq.md)
...
See [tests/README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/tests/README.md) for unit test details.

## Developing

- [Developer Guide](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/developer-guide.md) -- How to add new steps, analysis modules, harnesses, scenarios, and experiments
- [Package Architecture](https://github.com/llm-d/llm-d-benchmark/blob/main/llmdbenchmark/README.md) -- Overview of the `llmdbenchmark` package structure and submodules

## Contribute

- [How to contribute](https://github.com/llm-d/llm-d-benchmark/blob/main/CONTRIBUTING.md), including development process and governance.
- See [Developer Guide](https://github.com/llm-d/llm-d-benchmark/blob/main/docs/developer-guide.md) for how to add new steps, harnesses, scenarios, and analysis modules.
...
Licensed under Apache License 2.0. See [LICENSE](https://github.com/llm-d/llm-d-benchmark/blob/main/LICENSE) for details.

:::info Content Source
This content is automatically synced from [README.md](https://github.com/llm-d/llm-d-benchmark/blob/main/README.md) on the `main` branch of the llm-d/llm-d-benchmark repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d-benchmark/edit/main/README.md) or [create an issue](https://github.com/llm-d/llm-d-benchmark/issues).
:::
