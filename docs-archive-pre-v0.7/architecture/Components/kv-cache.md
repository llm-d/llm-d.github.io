...
sidebar_position: 6
keywords: [llm-d, KV cache, tokenization, cache offloading, memory optimization]
---
...
[![License](https://img.shields.io/github/license/llm-d/llm-d-kv-cache)](https://github.com/llm-d/llm-d-kv-cache/blob/main/LICENSE)
...
> For a more detailed breakdown, please see the high-level [Architecture](https://github.com/llm-d/llm-d-kv-cache/blob/main/docs/architecture.md) and the [Configuration](https://github.com/llm-d/llm-d-kv-cache/blob/main/docs/configuration.md) docs.

-----

### Examples

* [**KVCache Indexer**](https://github.com/llm-d/llm-d-kv-cache/blob/main/examples/kv_cache_index/README.md):
  A reference implementation showing how to run and use the `kvcache.Indexer` module
* [**KVCache Aware Scorer**](https://github.com/llm-d/llm-d-kv-cache/blob/main/examples/kv_cache_aware_scorer/README.md):
  A reference implementation of how to integrate the `kvcache.Indexer` into a scheduler like the `llm-d-inference-scheduler`
* [**KV-Events**](https://github.com/llm-d/llm-d-kv-cache/blob/main/examples/kv_events/README.md):
...
:::info Content Source
This content is automatically synced from [README.md](https://github.com/llm-d/llm-d-kv-cache/blob/main/README.md) on the `main` branch of the llm-d/llm-d-kv-cache repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d-kv-cache/edit/main/README.md) or [create an issue](https://github.com/llm-d/llm-d-kv-cache/issues).
:::
