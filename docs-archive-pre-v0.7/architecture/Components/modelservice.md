...
sidebar_label: Model Service
sidebar_position: 2
keywords: [llm-d, model service, helm chart, kubernetes, LLM deployment, vLLM]
---
...
In addition to deploying the GAIE chart, an `HTTPRoute` is typically required to connect the `Gateway` to the `InferencePool`. Creating an HTTPRoute is not part of either chart. Some examples are provided [here](https://github.com/llm-d-incubation/llm-d-modelservice/blob/main/examples/README.md#httproute-examples).

## Examples

See [examples](https://github.com/llm-d-incubation/llm-d-modelservice/blob/main/examples) for how to use this Helm chart. Some examples contain placeholders for components such as the gateway name. Use the `--set` flag to override placeholders. For example,
...
We welcome contributions to llm-d-modelservice! Please see our [Contributing Guide](https://github.com/llm-d-incubation/llm-d-modelservice/blob/main/CONTRIBUTING.md) for detailed information on how to contribute to this project, including guidelines for submitting issues, pull requests, and development setup.
...
:::info Content Source
This content is automatically synced from [README.md](https://github.com/llm-d-incubation/llm-d-modelservice/blob/main/README.md) on the `main` branch of the llm-d-incubation/llm-d-modelservice repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d-incubation/llm-d-modelservice/edit/main/README.md) or [create an issue](https://github.com/llm-d-incubation/llm-d-modelservice/issues).
:::
