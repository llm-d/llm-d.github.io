...
* **Run it.** The [GLM-5.2 H200 guide](https://github.com/llm-d/llm-d/blob/main/guides/agentic-serving/glm-5-2-h200.md) provides the serving pattern and composable MTP, CPU-offloading, and context-length components.
...
The agentic-serving cookbooks include [Nemotron-3-Ultra-550B on H200](https://github.com/llm-d/llm-d/blob/main/guides/agentic-serving/nemotron-3-ultra-550b-h200.md), with P/D disaggregation and CPU KV offloading, and [Qwen3-Coder-480B on TPU v7](https://github.com/llm-d/llm-d/blob/main/guides/agentic-serving/qwen3-coder-480b-tpu.md), with routing and CPU offloading. The [GLM-5.2 H200 configuration](https://github.com/llm-d/llm-d/blob/main/guides/agentic-serving/glm-5-2-h200.md) follows the same agentic-serving pattern.
