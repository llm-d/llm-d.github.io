...
Recent external validations demonstrated llm-d's performance gains ([3× throughput on AMD](https://llm-d.ai/blog/production-grade-llm-inference-at-scale-kserve-llm-d-vllm), [70% higher tokens/sec on AWS B200](https://aws.amazon.com/blogs/machine-learning/introducing-disaggregated-inference-on-aws-powered-by-llm-d/), [40% latency reduction from Google](https://llm-d.ai/blog/predicted-latency-based-scheduling-for-llms)). Those capabilities remain and continue to improve, but v0.7's investment is making them accessible: onboarding guides, tested installation paths, and confidence the guides work on your target platform.
