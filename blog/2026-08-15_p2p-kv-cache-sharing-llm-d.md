...
but the endpoint holding it - one serving instance: often a pod, sometimes a
rank within a pod or a multi-node instance - is busy. Route the request to
...
load, and move the finished KV to it.
