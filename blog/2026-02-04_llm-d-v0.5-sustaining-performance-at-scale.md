...
*Figure 3: KV-cache throughput under growing user concurrency on Llama-3.1-70B (4×NVIDIA H100). 16K token requests with previously-seen prompts. GPU-only collapses once HBM is saturated; storage offload sustains \~185k tok/s as concurrency scales (13.9x improvement at 250 users).*
