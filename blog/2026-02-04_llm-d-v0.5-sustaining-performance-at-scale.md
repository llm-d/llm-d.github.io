...
<div style={{textAlign: 'center', margin: '20px 0'}}>
  <img src={require('../docs/assets/images/wideep-on-b200.png').default} alt="Wide-EP on Nvidia B200" style={{width: '90%', height: 'auto'}} />
</div>
...
<div style={{textAlign: 'center', margin: '20px 0'}}>
  <img src={require('../docs/assets/images/tftp-vs-qps.png').default} alt="TFTP vs QPS" style={{width: '90%', height: 'auto'}} />
</div>
...
<div style={{textAlign: 'center', margin: '20px 0'}}>
  <img src={require('../docs/assets/images/kvcache-load-across-tiers.png').default} alt="Single-request KV-cache load across tiers" style={{width: '75%', height: 'auto'}} />
</div>

*Figure 3: Single-request KV-cache load across tiers on Llama-3.1-70B (4×NVIDIA H100). A comparison showing that while local HBM/DRAM is faster for single requests, storage offloading via an IBM Scale backed PVC provides up to 16.8x speedup over prefill for long contexts, with gains scaling by available storage bandwidth.*
...
*Figure 4: KV-cache throughput under growing user concurrency on Llama-3.1-70B (4×NVIDIA H100). 16K token requests with previously-seen prompts. GPU-only collapses once HBM is saturated; storage offload sustains \~185k tok/s as concurrency scales (13.9x improvement at 250 users).*
...
<div style={{textAlign: 'center', margin: '20px 0'}}>
  <img src={require('../docs/assets/images/lora-aware-scheduling.png').default} alt="LoRA-precise prefix caching" style={{width: '75%', height: 'auto'}} />
</div>

*Figure 5: LoRA-aware prefix-cache scheduling improves throughput. Prefix-cache aware scheduling mitigates LoRA overhead by minimizing effective compute and avoiding redundant LoRA kernel execution, delivering higher throughput than standard K8s round-robin load-balancing.*
...
<div style={{textAlign: 'center', margin: '20px 0'}}>
  <img src={require('../docs/assets/images/pdtransfer-under-congestion.png').default} alt="PD transfer under congestion" style={{width: '75%', height: 'auto'}} />
</div>

*Figure 6: PD transfer latency growth under congestion. Comparing baseline vs. congested states for UCX and UCCL transport.*
