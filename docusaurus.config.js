  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: "llm-d-0-9-0",
        content:
          '🎉 <b>llm-d 0.9 is here!</b> Hardened for scale with router HA, KEDA autoscaling &amp; end-to-end observability, plus diffusion models and GB200/GB300 support. <a href="/blog/llm-d-v0.9-hardened-for-scale"><b>Read the release blog →</b></a>',
        textColor: "#ffffff",
        isCloseable: true,
      },
      docs: {
