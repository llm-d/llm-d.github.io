...
1. Deploy a Kubernetes Gateway (see [gateway guides](/resources/gateway))
2. Install llm-d router with HTTPRoute enabled (see [optimized-baseline guide](/well-lit-paths/optimized-baseline#gateway-mode))
