...
To generate traffic and populate error metrics for testing, use the [traffic generation script](https://github.com/llm-d/llm-d/blob/release-0.8/guides/recipes/observability/generate-traffic-basic.sh).
...
**Error metrics** only appear after the first error occurs. Use the [traffic generation script](https://github.com/llm-d/llm-d/blob/release-0.8/guides/recipes/observability/generate-traffic-basic.sh) to populate them for testing.
