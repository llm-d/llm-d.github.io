...
This page covers how to enable and interpret metrics from an llm-d deployment. For Prometheus and Grafana installation, see [Observability Setup](/resources/observability/setup) first.
...
- A running llm-d deployment with an InferencePool and model servers — see the [quickstart](/getting-started/quickstart) if needed
- Prometheus and Grafana installed — see [Observability Setup](/resources/observability/setup)
