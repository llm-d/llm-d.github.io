...
- [P/D Disaggregation Well-Lit Path](/guides/pd-disaggregation) — deployment patterns using NIXL
- [Wide Expert-Parallelism Well-Lit Path](/guides/wide-expert-parallelism) — multi-node deployment with DeepEP networking
