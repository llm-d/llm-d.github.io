...
- [P/D Disaggregation Well-Lit Path](/well-lit-paths/pd-disaggregation) — deployment patterns using NIXL
- [Wide Expert-Parallelism Well-Lit Path](/well-lit-paths/wide-expert-parallelism) — multi-node deployment with DeepEP networking
- [Model Servers](/architecture/core/model-servers) — vLLM/SGLang configuration including KV transfer flags
