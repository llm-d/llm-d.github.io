...
- [P/D Disaggregation Well-Lit Path](/guides/foundations/pd-disaggregation) — deployment patterns using NIXL
- [Wide Expert-Parallelism Well-Lit Path](/guides/foundations/wide-expert-parallelism) — multi-node deployment with DeepEP networking
