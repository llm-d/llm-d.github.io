...
![machinesets](/img/docs/machinesets.png)
...
![operators](/img/docs/installed_operators.png)
...
![Grafana dashboard empty of data](/img/docs/grafana_empty.png)
