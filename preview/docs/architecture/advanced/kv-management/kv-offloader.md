...
For deployment recipes, see the [Tiered Prefix Cache Guide](/well-lit-paths/tiered-prefix-cache).
...
- [Tiered Prefix Cache Guide](/well-lit-paths/tiered-prefix-cache) — Step-by-step deployment guides
