---
slug: /well-lit-paths/flow-control
---
...
For detailed step-by-step instructions on how to deploy and configure Flow Control, see the [Flow Control Guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/flow-control).
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/flow-control.svg" alt="Flow Control" />
  </picture>
</p>
