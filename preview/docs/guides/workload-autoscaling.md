...
See the [workload autoscaling guide](https://github.com/llm-d/llm-d/tree/${BRANCH}/guides/workload-autoscaling) for manifests and step-by-step deployment instructions for both paths.
