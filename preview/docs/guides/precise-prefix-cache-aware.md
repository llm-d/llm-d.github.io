...
See the [precise prefix cache-aware guide](https://github.com/llm-d/llm-d/tree/release-0.7/guides/precise-prefix-cache-aware) for manifests and step-by-step deployment.
