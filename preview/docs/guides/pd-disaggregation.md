---
slug: /well-lit-paths/pd-disaggregation
---
...
See the [P/D Disaggregation guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/pd-disaggregation) for manifests and step-by-step deployment.
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/pd-disaggregation.svg" alt="P/D Disaggregation" />
  </picture>
</p>
...
See [PD Architecture](../architecture/advanced/disaggregation/index.md) for more details.
