---
slug: /well-lit-paths/optimized-baseline
---
...
See the [optimized baseline guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/optimized-baseline) for manifests and step-by-step deployment.
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/prefix-aware-routing.svg" alt="Prefix-Aware Routing" />
  </picture>
</p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" />
    <img src="/img/docs/load-aware-routing.svg" alt="Load-Aware Routing" />
  </picture>
</p>
