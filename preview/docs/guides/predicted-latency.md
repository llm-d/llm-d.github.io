...
See the [Predicted Latency guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/predicted-latency-routing) for manifests and step-by-step deployment.
