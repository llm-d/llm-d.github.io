...
See the [Predicted Latency guide](https://github.com/llm-d/llm-d/tree/release-0.7/guides/predicted-latency-based-scheduling) for manifests and step-by-step deployment.
...
<p align="center">
  <picture>
    ...
    <img src="/docs/img/docs/latency-predictor.svg" alt="Latency Predictor" />
  </picture>
</p>
