---
slug: /well-lit-paths/predicted-latency
---

# Predicted Latency-Based Scheduling

llm-d's [optimized baseline guide\](/guides/optimized-baseline).md) leverages load signals and prefix-cache affinity to schedule requests, combining the signals together with heuristics.
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/latency-predictor.svg" alt="Latency Predictor" />
  </picture>
</p>
