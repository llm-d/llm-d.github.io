---
slug: /well-lit-paths/wide-expert-parallelism
---
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/dp-ep-deployment.svg" alt="DP/EP deployment" />
  </picture>
</p>
...
See the [Wide Expert Parallelism guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/wide-ep-lws) for manifests and step-by-step deployment.
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" />
    <img src="/img/docs/wide-ep.svg" alt="Multi-Node Wide Expert Parallelism" />
  </picture>
</p>
...
* [PD Architecture](../architecture/advanced/disaggregation/index.md) for more details on disaggregation in llm-d
