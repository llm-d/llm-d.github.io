...
[optimized baseline](/well-lit-paths/optimized-baseline) for prefix- and load-aware routing,
[tiered KV-cache offloading](/well-lit-paths/tiered-prefix-cache) to keep idle sessions resident,
[precise prefix-cache routing](/well-lit-paths/precise-prefix-cache-routing) for exact KV-state visibility, and [P/D disaggregation](/well-lit-paths/pd-disaggregation) for interactivity under load — into
