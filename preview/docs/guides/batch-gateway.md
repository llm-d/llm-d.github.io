...
- A working llm-d Router, inference pool, and at least one model server. If you don't have this, start with [getting-started/quickstart.md](/getting-started/quickstart).
