---
slug: /well-lit-paths/multimodal-serving
---
...
See the [multimodal aggregation guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/multimodal-serving/aggregation) for aggregated guide manifests and step-by-step deployment.

### Multimodal Disaggregated Guide

See the [multimodal e-disaggregation guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/multimodal-serving/e-disaggregation) for disaggregated guide manifests and step-by-step deployment.
...
:::note
For the high-level scheduling architecture flow and EPP load-balancing diagrams, see the [Optimized Baseline guide](/well-lit-paths/optimized-baseline#architecture).
:::
...
`Tokens = (Image Width * Image Height) / Factor`
...
* See [Optimized Baseline](/well-lit-paths/optimized-baseline) for details on text-based scheduling and general load-balancing.
* See [EPP Architecture](/architecture/core/router/epp) for more details.
