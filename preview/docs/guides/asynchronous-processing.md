---
slug: /well-lit-paths/asynchronous-processing
---
...
See the [asynchronous processing guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/asynchronous-processing) for deployment instructions using Helm and supported queue implementations (Redis or GCP Pub/Sub).
...
<p align="center">
  <picture>
    ...
    <img src="/img/docs/async-processor.svg" alt="Async Processor Architecture" />
  </picture>
</p>
