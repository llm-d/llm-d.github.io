---
slug: /well-lit-paths/precise-prefix-cache-routing
---
...
See the [precise prefix cache routing guide](https://github.com/llm-d/llm-d/tree/release-0.8/guides/precise-prefix-cache-routing) for manifests and step-by-step deployment.
