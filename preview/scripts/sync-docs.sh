...
# Gateway docs live under docs/resources/gateway/ in upstream llm-d.
...
find "$DOCS_DIR/guides" -name "*.md" -print0 | while IFS= read -r -d '' file; do
    sed_inplace \
        -e 's|\](../prereq/gateways)|\](https://github.com/llm-d/llm-d/tree/main/docs/resources/gateway)|g' \
        -e 's|\](../../prereq/gateways)|\](https://github.com/llm-d/llm-d/tree/main/docs/resources/gateway)|g' \
        -e 's|\](/docs/prereq/gateways)|\](https://github.com/llm-d/llm-d/tree/main/docs/resources/gateway)|g' \
...
find "$DOCS_DIR/guides" -name "*.md" -print0 | while IFS= read -r -d '' file; do
    sed_inplace \
        ...
        -e 's|\](../../04_customizing_a_guide\.md)|\](https://github.com/llm-d/llm-d/tree/main/docs/resources/gateway)|g' \
        -e 's|\](/docs/04_customizing_a_guide\.md)|\](https://github.com/llm-d/llm-d/tree/main/docs/resources/gateway)|g' \
