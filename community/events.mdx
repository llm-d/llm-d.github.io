  ...
  const events = [
    {
      ...
      cost: 'Paid',
      href: 'https://pytorch.org/event/pytorch-conference-2026/',
      sessions: [],
    },
    {
      month: 'November 2026',
      ...
      sessions: [
        {
          title: 'Co-located Events and Project Lightning Talks',
          date: 'Nov 9, 2026',
          time: 'All day',
          location: 'Salt Lake City',
          href: 'https://events.linuxfoundation.org/kubecon-cloudnativecon-north-america/program/schedule-at-a-glance/',
        },
        {
          title: 'Keynotes, Breakouts, and Solutions Showcase',
          date: 'Nov 10, 2026',
          time: 'All day',
          location: 'Salt Lake City',
          href: 'https://events.linuxfoundation.org/kubecon-cloudnativecon-north-america/program/schedule-at-a-glance/',
