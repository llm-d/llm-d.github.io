...
This project adheres to the llm-d [Code of Conduct and Covenant](code-of-conduct). By participating, you are expected to uphold this code.
...
* **SIGs:** Join one of our [Special Interest Groups (SIGs)](sigs) to contribute to specific areas of the project and collaborate with domain experts.
...
:::info Content Source
This content is automatically synced from [CONTRIBUTING.md](https://github.com/llm-d/llm-d/blob/main/CONTRIBUTING.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/CONTRIBUTING.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
