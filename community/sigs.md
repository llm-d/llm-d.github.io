...
sidebar_label: Special Interest Groups (SIGs)
sidebar_position: 4
---
...
- All SIG work follows the project's [contribution guidelines](https://github.com/llm-d/llm-d/blob/main/CONTRIBUTING.md)
...
3. **Proposal process**: Submit proposal following [project contribution guidelines](https://github.com/llm-d/llm-d/blob/main/CONTRIBUTING.md)
...
- **Contributing Guidelines**: [CONTRIBUTING.md](https://github.com/llm-d/llm-d/blob/main/CONTRIBUTING.md)
...
:::info Content Source
This content is automatically synced from [SIGS.md](https://github.com/llm-d/llm-d/blob/main/SIGS.md) on the `main` branch of the llm-d/llm-d repository.

📝 To suggest changes, please [edit the source file](https://github.com/llm-d/llm-d/edit/main/SIGS.md) or [create an issue](https://github.com/llm-d/llm-d/issues).
:::
